...
class Dimensions {
  // Screen size
  static double mobileScreenWidth = 375;

  // Padding and margin
  static double paddingSize = 20.00.r;
  static double margin = 20.r;
  ...
  static double iconSizeextraLarge = 70.00.h;
  ...
  static double heightSize = 15.00.h;
