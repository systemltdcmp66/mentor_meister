import 'package:mentormeister/features/Student/attemp_quiz.dart';
...
class _QuizzesPageStudentState extends State<QuizzesPageStudent>
    ...
    return SafeArea(
      child: Scaffold(
        backgroundColor: CustomColor
            .primaryBGColor, // Changed to default white color for demonstration
            ...
            trailing: ElevatedButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const AttemptQuizPage()));
              },
