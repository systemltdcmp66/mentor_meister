...
class GetHiredTeacherInfos extends UseCaseWithoutParams<List<TeacherInfo>> {
  const GetHiredTeacherInfos(this._repository);

  final TeacherSignUpRepository _repository;

  @override
  ResultFuture<List<TeacherInfo>> call() => _repository.getHiredTeacherInfos();
}
