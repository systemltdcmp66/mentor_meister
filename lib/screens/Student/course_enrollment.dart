import 'package:mentormeister/screens/Student/student_enrolled_courses.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: Center(
          child: CustomAppBar(title: 'Create Details',centerTitle: true, onBookmarkPressed: () {}, icon: Icons.favorite_border),
        ),
      ),
          ...
          child:    Column(
            ...
            children: [
              ...
              Center(
                child: SizedBox(
                  width: 150.w,
                    child: CustomButton(text: 'Enroll', onPressed: (){
                      setState(() {
                        isEnrolled = true;
                      });
                    })),
