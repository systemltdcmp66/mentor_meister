              ...
              if(!isSearching)...[
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: allVideoCards.length, // Use allVideoCards instead of filteredVideoCards
                    itemBuilder: (BuildContext context, int index) {
                      return buildVideoCard(allVideoCards[index]); // Use allVideoCards instead of filteredVideoCards
                    },
                  ),
                ),
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const CourseDetailStudent()));
                },
