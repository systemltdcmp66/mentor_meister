...
class _TeachersPageState extends State<TeachersPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: const CustomAppBar(title: 'Teachers', centerTitle: true,),
      ),
      body: Builder(
  ...
  void _showDialog(BuildContext context, Teacher teacher) async {
    ...
    List<List<bool>> selectedTimes = List.generate(7, (_) => List.filled(7, false));
    await showDialog(
      context: context,
      builder: (BuildContext context) {
        return Center(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      formatDate(currentDate, currentDate.add(const Duration(days: 7))),
