        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Padding(
                    ...
                    child: Center(
                      child: Row(
                        ...
                        children: [
                          Text('Total Amount', style: CustomStyle.interh3,),
                          Text('\$30', style: CustomStyle.interh3,),
                        ],
                      ),
                    ),
                  )
             ...
             isCardSave? SizedBox(height: 200.h,): const SizedBox(),
              CustomButton(text: isCardSave ?'Pay Now': 'Save Card' , onPressed: (){
                setState(() {
                  isCardSave = true;
                });
              }),
    ...
    return Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                 Text(label, style: CustomStyle.interh3,),
                  SizedBox(height: Dimensions.heightSize,),
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Image.asset(widget.selectedCardImage?? '', height: 50, width: 50,),
                      ],
                    ),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: mainSpaceBet,
                    children: [
                      Image.asset(widget.selectedCardImage??'', height: 50.h,width: 50.w,),
                      const Icon(Icons.select_all,color: CustomColor.whiteColor,),
                    ],
                  ),
                  Text(
                    'John',
                  ...
                  Row(
                    mainAxisAlignment: mainSpaceBet,
                    children: [
                      Text('04/23',style: CustomStyle.whiteh2,),
                      Text(
                        widget.selectedCardName ?? '',
                        style: CustomStyle.whiteh2,
