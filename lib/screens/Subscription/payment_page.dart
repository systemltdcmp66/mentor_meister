import 'package:mentormeister/screens/Subscription/add_card_detail_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
              buildGestureDetector('assets/subscription/mastercard.png', 'DebitCard'),
              SizedBox(height: Dimensions.heightSize),
              buildGestureDetector('assets/subscription/paypal.png', 'Poyneer'),
              SizedBox(height: Dimensions.heightSize),
              buildGestureDetector('assets/subscription/apple_pay.png', 'Apple Pay'),
              const Spacer(),
              CustomButton(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: selectedCardName == text ? CustomColor.redColor : Colors.transparent),
        ),
        child: Row(
          children: [
