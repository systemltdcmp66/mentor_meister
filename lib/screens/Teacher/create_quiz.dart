...
class _CreateQuizScreenState extends State<CreateQuizScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: Dimensions.heightSize,),
            CustomButton(text: 'Publish Quiz', onPressed: () {  },),
  ...
  Widget _buildDropdownField(String label, List<String> options, String selectedValue, TextEditingController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
  ...
  Widget _buildRowDropdownField(String label, List<String> options, String selectedValue, TextEditingController controller) {
    return Row(
      children: <Widget>[
        Expanded(
