...
import 'package:mentormeister/screens/Teacher/live_session_start.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(title: 'Live Session', centerTitle: true, onBookmarkPressed: (){}, icon: Icons.bookmark_added_outlined,),
      ),
      body: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  CircleAvatar(
                    backgroundImage: const AssetImage('assets/teacher/person.png'), // Placeholder image
                    radius: 20.r,
                  ),
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: isCleared? const Color(0xff6daa6c).withOpacity(0.74):const Color(0xfffcdddd),
                    ),
