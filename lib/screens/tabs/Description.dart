      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Row(
              children: [
                Image.asset('assets/teacher/person.png', height: 100,width: 100,),
                SizedBox(width: Dimensions.widthSize,),
                Column(
                  mainAxisAlignment: mainStart,
                  crossAxisAlignment: crossStart,
                  children: [
                    Text(fullName, style: CustomStyle.blackh2,),
                    SizedBox(height: Dimensions.marginBetweenInputTitleAndBox),
                    ...
                    Text('Example : “teacher with five years\nof experience in the field”', style: TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w300,),),
                  ],
                )
              ],
            ),
